...
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (1, 'Imprint', 'Impressum - Altmühlsee', 'Altmühlsee Impressum', 'Impressum', '<p>Wie Sie hier sehen kann man den Inhalt jetzt frei gestallten.  </p><p><strong>Die Image function wird noch nicht unterstützt</strong></p><p><strong>Aber fett schreiben und absätze sowie </strong><a href="http://altmuehlsee.redkitty.de/"><strong>links einfügen</strong></a></p><ol><li><strong>Was kommt noch?</strong></li><li>Image function</li></ol>', 1, 'impressum');
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (2, 'Index', 'Altmühlsee Portal - Ferienwohnung Hotel Gasthof Camping Freizeit und Veranstaltungen - Altmühlsee Urlaub', 'Das Altmühlsee Portal hat die passende Unterkunft rund um den Altmühlsee: Ferienwohnung, Hotel, Gasthof oder Camping. Restaurant, Freizeit und  Veranstaltungen für Ihren Altmühlsee Urlaub.', 'Entwicklungs-Fortschritt', '<div class="row"><p>Der Entwicklungs-Fortschritt ist <a href="https://github.com/rogergerecke/alt-sym">hier im Repro</a> zu sehen.</p>  <p>Die Suchfuntion ist jetzt überarbeitet.</p>  <p>Der Link zum Brommbachsee ist jetzt oben rechts.</p>  <p>Die Premium-Acounts werden dann schon auf der Startseite angezeigt. </p></div>', 1, 'index');
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (3, 'Privacy', 'Datenschutzerklärung', 'Datenschutzerklärung', 'Datenschutzerklärung', '  <p>Wir freuen uns sehr über Ihr Interesse an unserem Unternehmen. Datenschutz hat einen besonders hohen
            Stellenwert für die Geschäftsleitung der Webservice Albrecht. Eine Nutzung der Internetseiten der Webservice
            Albrecht ist grundsätzlich ohne jede Angabe personenbezogener Daten möglich. Sofern eine betroffene Person
        ...
        <p>Die Verarbeitung personenbezogener Daten, beispielsweise des Namens, der Anschrift, E-Mail-Adresse oder
            ...
            übereinstimmung mit den für die Webservice Albrecht geltenden landesspezifischen Datenschutzbestimmungen.
        ...
        <p>Die Webservice Albrecht hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
        ...
        <p>Die Datenschutzerklärung der Webservice Albrecht beruht auf den Begrifflichkeiten, die durch den Europäischen
        ...
        <p>Webservice Albrecht</p>
        <p>Bismarckstr. 27</p>
        <p>91710 Gunzenhausen</p>
        <p>Deutschland</p>
        <p>Tel.: 09831 881354</p>
        <p>E-Mail: info@webservice-albrecht.de</p>
        <p>Website: altmuehlsee.com</p>

        <h4>3. Cookies</h4>
        <p>Die Internetseiten der Webservice Albrecht verwenden Cookies. Cookies sind Textdateien, welche über einen
        ...
        <p>Durch den Einsatz von Cookies kann die Webservice Albrecht den Nutzern dieser Internetseite
        ...
        <p>Die Internetseite der Webservice Albrecht erfasst mit jedem Aufruf der Internetseite durch eine betroffene
        ...
        <p>Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Webservice Albrecht keine Rückschlüsse
            ...
            optimieren, (3) die dauerhafte Rückschlüsse unserer informationstechnologischen Systeme und der
            ...
            Daten und Informationen werden durch die Webservice Albrecht daher einerseits statistisch und ferner mit dem
        ...
        <p>Der für die Verarbeitung Verantwortliche erteilt jeder betroffenen Person jederzeit auf Anfrage Auskunft
            darüber, welche personenbezogenen Daten über die betroffene Person gespeichert sind. Ferner berichtigt oder
            löscht der für die Verarbeitung Verantwortliche personenbezogene Daten auf Wunsch oder Hinweis der
            betroffenen Person, soweit dem keine gesetzlichen Aufbewahrungspflichten entgegenstehen. Die Gesamtheit der
            Mitarbeiter des für die Verarbeitung Verantwortlichen stehen der betroffenen Person in diesem Zusammenhang
            als Ansprechpartner zur Verfügung.</p>

        <h4>6. Kontaktmöglichkeit über die Internetseite</h4>
        <p>Die Internetseite der Webservice Albrecht enthält aufgrund von gesetzlichen Vorschriften Angaben, die eine
            schnelle elektronische Kontaktaufnahme zu unserem Unternehmen sowie eine unmittelbare Kommunikation mit uns
        ...
        <ul style="list-style: none;">
            ...
            <li>
                ...
                <p>Sofern einer der oben genannten Gründe zutrifft und eine betroffene Person die Löschung von
                    personenbezogenen Daten, die bei der Webservice Albrecht gespeichert sind, veranlassen möchte, kann
                    sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung Verantwortlichen wenden. Der
                    Mitarbeiter der Webservice Albrecht wird veranlassen, dass dem Löschverlangen unverzüglich
                    nachgekommen wird.</p>

                <p>Wurden die personenbezogenen Daten von der Webservice Albrecht öffentlich gemacht und ist unser
                    Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der personenbezogenen
                    Daten verpflichtet, so trifft die Webservice Albrecht unter Berücksichtigung der verfügbaren
                    Technologie und der Implementierungskosten angemessene Maßnahmen, auch technischer Art, um andere
                    für die Datenverarbeitung Verantwortliche, welche die veröffentlichten personenbezogenen Daten
                    verarbeiten, darüber in Kenntnis zu setzen, dass die betroffene Person von diesen anderen für die
                    Datenverarbeitung Verantwortlichen die Löschung sämtlicher Links zu diesen personenbezogenen Daten
                    oder von Kopien oder Replikationen dieser personenbezogenen Daten verlangt hat, soweit die
                    Verarbeitung nicht erforderlich ist. Der Mitarbeiter der Webservice Albrecht wird im Einzelfall das
            ...
            <li><h4>e) Recht auf Einschränkung der Verarbeitung</h4>
                ...
                <p>Sofern eine der oben genannten Voraussetzungen gegeben ist und eine betroffene Person die
                    Einschränkung von personenbezogenen Daten, die bei der Webservice Albrecht gespeichert sind,
                    verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
                    Verantwortlichen wenden. Der Mitarbeiter der Webservice Albrecht wird die Einschränkung der
            ...
            <li><h4>f) Recht auf Datenübertragbarkeit</h4>
                ...
                <p>Ferner hat die betroffene Person bei der Ausübung ihres Rechts auf Datenübertragbarkeit gemäß Art. 20
                    ...
                    ist und sofern hiervon nicht die Rechte und Freiheiten anderer Personen beeinträchtigt werden.</p>

                <p>Zur Geltendmachung des Rechts auf Datenübertragbarkeit kann sich die betroffene Person jederzeit an
                    einen Mitarbeiter der Webservice Albrecht wenden.</p>
            ...
            <li>
                ...
                <p>Die Webservice Albrecht verarbeitet die personenbezogenen Daten im Falle des Widerspruchs nicht mehr,
                ...
                <p>Verarbeitet die Webservice Albrecht personenbezogene Daten, um Direktwerbung zu betreiben, so hat die
                    ...
                    Webservice Albrecht der Verarbeitung für Zwecke der Direktwerbung, so wird die Webservice Albrecht
                ...
                <p>Zudem hat die betroffene Person das Recht, aus Gründen, die sich aus ihrer besonderen Situation
                    ergeben, gegen die sie betreffende Verarbeitung personenbezogener Daten, die bei der Webservice
                    Albrecht zu wissenschaftlichen oder historischen Forschungszwecken oder zu statistischen Zwecken
                ...
                <p>Zur Ausübung des Rechts auf Widerspruch kann sich die betroffene Person direkt jeden Mitarbeiter der
                    Webservice Albrecht oder einen anderen Mitarbeiter wenden. Der betroffenen Person steht es ferner
            ...
            <li><h4>h) Automatisierte Entscheidungen im Einzelfall einschließlich Profiling</h4>
                ...
                <p>Ist die Entscheidung (1) für den Abschluss oder die Erfüllung eines Vertrags zwischen der betroffenen
                    ...
                    der betroffenen Person, trifft die Webservice Albrecht angemessene Maßnahmen, um die Rechte und
                ...
                <p>Mächte die betroffene Person Rechte mit Bezug auf automatisierte Entscheidungen geltend machen, kann
        ...
        <p>Art. 6 I lit. a DS-GVO dient unserem Unternehmen als Rechtsgrundlage für Verarbeitungsvorgänge, bei denen wir
            ...
            erforderlich wird, wie beispielsweise zur Erfällung steuerlicher Pflichten, so basiert die Verarbeitung auf
            ...
            schützen. Dies würe beispielsweise der Fall, wenn ein Besucher in unserem Betrieb verletzt werden würde und
        ...
        <p>Diese Datenschutzerklärung wurde durch den Datenschutzerklärungs-Generator der DGD Deutsche Gesellschaft für
            Datenschutz GmbH, die als <a
                    ...
                    rel="nofollow" target="_blank">Externer Datenschutzbeauftragter Memmingen</a> tätig ist, in
            Kooperation mit dem <a href="https://www.wbs-law.de/it-recht/datenschutzrecht" rel="nofollow"
                                   target="_blank">Anwalt für Datenschutzrecht</a> Christian Solmecke erstellt.
        </p>', 1, 'datenschutzerklearung');
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (4, 'Host', 'Gastgeber in Altmühlsee', 'Das Gastgeber Verzeichniss von Altmühlsee', 'Gastgeber', '', 1, 'gastgeber');
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (5, 'Region', 'Steckbrief Altmühlsee', 'Steckbrief Altmühlsee', 'Steckbrief Altmühlsee', 'Steckbrief Altmühlsee', 1, 'region');
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (6, 'Contact', 'Unser Kontakt Formular', 'null', 'Kontakt', 'Hier unser Kontakt Formular', 1, 'kontakt');
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (7, 'Entry', 'Eintrag erstellen', 'Eintrag Erstellen', 'Inserat', '
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
    <h1 class="display-4">Preise</h1>
    <p class="lead">Schnell und einfach das passende Paket für Sie auswählen vom kleinen ohne Bilder bis zum Profi Paket
        mit bis zu 20 Bilder und priorisierten Listing.</p>
</div>
...
<div class="container">
    <div class="card-deck mb-3 text-center">
        ...
        <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
                <h1 class="card-title pricing-card-title">0 € <small class="text-muted">/ Jahr</small></h1>
                <ul class="list-unstyled mt-3 mb-4">
                    <li>Unterkunfts Eintrag</li>
                    <li class="text-danger">ohne Bilder</li>
                    <li>mit Adresse</li>
                    <li>mit Email</li>
                    <li>mit Telefon</li>
                    <li class="text-danger">ohne Beschreibungstext</li>
                    <li class="text-danger">ohne Entfernung zum See</li>
                    <li class="text-danger">ohne Detailtseite</li>
                </ul>
                <a class="btn btn-lg btn-block btn-outline-primary" href="/admin2/checkout.php?page_action=create_login&entry_type=0">Umsonst Starten</a>

                <!-- Collapse more Information -->
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseFree"
                        aria-expanded="false" aria-controls="collapseFree">
                    Mehr Details <i class="fas fa-angle-down"></i>
                </button>
                <div class="collapse multi-collapse" id="collapseFree">
                    <div class="card card-body">
                        Ihre Unterkunft wird mit Adresse, Telefon und E-Mail eingetragen.
                    </div>
                </div>
                <!-- Collapse more Information #END -->
        ...
        <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
                <h1 class="card-title pricing-card-title">49,98 € <small class="text-muted">/ Jahr</small></h1>
                <ul class="list-unstyled mt-3 mb-4">
                    <li>Unterkunfts Eintrag</li>
                    <li class="text-success">1 Bild</li>
                    <li>mit Adresse</li>
                    <li>mit Email</li>
                    <li>mit Telefon</li>
                    <li>mit Beschreibungstext</li>
                    <li>mit Entfernung zum See</li>
                    <li>mit Detailtseite</li>
                </ul>
                <a class="btn btn-lg btn-block btn-primary" href="/admin2/checkout.php?page_action=create_login&entry_type=1">Sie sind Profi</a>

                <!-- Collapse more Information -->
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseBasis"
                        aria-expanded="false" aria-controls="collapseBasis">
                    Mehr Details <i class="fas fa-angle-down"></i>
                </button>
                <div class="collapse multi-collapse" id="collapseBasis">
                    <div class="card card-body">
                        Ihre Unterkunft erscheint mit Adresse, Telefon, E-Mail und einem Bild. Verschiedene Preisangaben
                        für Ferienwohnungen oder Zimmer werden angezeigt. Ausführlicher Beschreibungstext unter Details
                        mit Entfernung zum See, Formular für direkte Buchungsanfrage, Link auf die Gastgeber Homepage,
                        Lage und Belegungsplan. Jeden Monat erhalten Sie als Gastgeber eine Statistik über die Aufrufe
                        Ihrer Unterkunft und die Anzahl der genutzten "merken" Funktion. Außerdem können Sie
        ...
        <div class="card mb-4 box-shadow">
            ...
            <div class="card-body">
                <h1 class="card-title pricing-card-title">99,96 € <small class="text-muted">/ Jahr</small></h1>
                <ul class="list-unstyled mt-3 mb-4">
                    <li>Unterkunfts Eintrag</li>
                    <li class="text-success"><span class="text-bold">Priorisierten Listing</span> <i
                                class="fas fa-info-circle fa-sm" data-toggle="tooltip" data-placement="top"
                                title="Priorisierte Einträge werden vor den Basis-Einträgen angezeigt"></i></li>
                    <li class="text-success text-bold">20 Bilder</li>
                    <li>+ Adresse</li>
                    <li>+ Email</li>
                    <li>+ Telefon</li>
                    <li>+ Beschreibungstext</li>
                    <li>+ Entfernung zum See</li>
                </ul>
                <a class="btn btn-lg btn-block btn-primary" href="/admin2/checkout.php?page_action=create_login&entry_type=2">Ich bin Experte</a>

                <!-- Collapse more Information -->
                <button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapsePremium"
                        aria-expanded="false" aria-controls="collapsePremium">
                    Mehr Details <i class="fas fa-angle-down"></i>
                </button>
                <div class="collapse multi-collapse" id="collapsePremium">
                    <div class="card card-body">
                        Ihre Unterkunft erscheint mit allen Funktionen wie beim Basiseintrag, zusätzlich sind bis zu 20
                        Bilder möglich. Die Unterkünfte mit Premiumeintrag werden bei der Ergebnisausgabe vor den
                        Unterkünften mit Basiseintrag aufgelistet.
                    </div>
                </div>
                <!-- Collapse more Information #END -->
...
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (8, 'Details', 'null', 'null', 'null', 'null', 1, 'details');
INSERT INTO sym_muehlsee.static_site (id, name, meta_title, meta_description, heading, content, status, url) VALUES (9, 'Leisure', 'Freizeit', 'Freizeit am Altmühlsee genißen', 'Freizeit', '<div>Die Freizeit am Altmühlsee genießen<br></div>', 1, 'freizeit');