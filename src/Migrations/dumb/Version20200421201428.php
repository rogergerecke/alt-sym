...
final class Version20200421201428 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hostel DROP INDEX UNIQ_38FBB1679393F8FE, ADD INDEX IDX_38FBB1679393F8FE (user_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE hostel DROP INDEX IDX_38FBB1679393F8FE, ADD UNIQUE INDEX UNIQ_38FBB1679393F8FE (user_id)');
