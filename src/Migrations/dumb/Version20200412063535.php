 ...
 */
final class Version20200412063535 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE open_weather (id INT AUTO_INCREMENT NOT NULL, data_type VARCHAR(255) NOT NULL, weather_data JSON DEFAULT NULL, import_status_code INT NOT NULL, date DATETIME on update CURRENT_TIMESTAMP, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
